...
public class Score {
    ...
    public static double copper = 1;
    public static double coal = 1;
    public static double lead = 1;
    public static double iron = 1;

    public static double coastFactor = 1.5;
    public static double riverFactor = 1.4;
    ...
    public static double subtropicalFactor = 1.2;
    public static double mediterraneanFactor = 1.4;
